-- Add size_id column to kiosk_order_items table
ALTER TABLE kiosk_order_items 
ADD COLUMN size_id UUID REFERENCES item_sizes(id);

-- Add index for better performance
CREATE INDEX IF NOT EXISTS idx_kiosk_order_items_size_id ON kiosk_order_items(size_id);

-- Update the create_kiosk_order function to handle the new column properly

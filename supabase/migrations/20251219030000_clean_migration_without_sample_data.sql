-- =====================================================
-- CLEAN DATABASE MIGRATION FOR FOOD ORDERING SYSTEM
-- (WITHOUT SAMPLE DATA)
-- =====================================================
-- This migration creates all necessary tables and functions
-- but does NOT include any sample data. You can manually
-- add your own categories, food items, and sizes.
...
DO $$
BEGIN
    RAISE NOTICE 'Clean database migration completed successfully!';
    ...
    RAISE NOTICE 'NO SAMPLE DATA INCLUDED - You can now manually add your own data';
    RAISE NOTICE 'The application will show empty states until you add categories and food items';
END $$;